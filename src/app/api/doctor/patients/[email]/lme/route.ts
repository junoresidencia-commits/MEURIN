...
export async function POST(
  ...
  const lme = await createLme({
    ...
    // CNS do médico: sempre reutilizado do perfil (cadastrado uma vez).
    doctorCns: b.doctorCns ? String(b.doctorCns) : doctor?.cns ?? null,
    ...
    patientCpf: b.patientCpf ? String(b.patientCpf) : access.cpf ?? null,
    patientCns: b.patientCns ? String(b.patientCns) : access.cns ?? null,
