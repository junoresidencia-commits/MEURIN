  ...
  return [
    {
      ...
      bio: "Especialista em doença renal crônica e acompanhamento de pacientes dialíticos.",
    ...
    },
    {
      ...
      bio: "Atendimento online focado em hipertensão arterial e preservação da função renal.",
